<div class="bg-gradient-to-b from-emerald-50 py-8 to-emerald-200 min-h-full min-w-full">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center mb-6">
            <h1 class="text-2xl font-bold text-gray-900">Kelola Postingan</h1>
            <a wire:navigate href="{{ route('admin.dashboard.post.create') }}"
                class="bg-emerald-600 hover:bg-emerald-700 text-white font-medium py-2 px-4 rounded-lg flex items-center shadow-md transition duration-150 ease-in-out">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="space-y-4">
                    ...
                    <div class="relative">
                        <input type="text" wire:model.live.debounce.300ms="term"
                            class="w-full pl-10 pr-4 py-2 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-emerald-400 transition duration-300"
                ...
                <div class="space-y-4">
                    ...
                    <div x-data="{
                        ...
                        <!-- Label -->
                        <label class="block text-sm font-medium text-gray-700 mb-1">Filter berdasarkan waktu</label>
                        ...
                        <tr wire:key="{{ $post->id }}" class="hover:bg-gray-50">
                            <td class="px-6 py-4">
                                <div class="flex flex-col">
                                    ...
                                    <div class="trix-content text-xs text-gray-600 mt-2 pr-4">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                <div class="flex space-x-2">
                                    <button wire:click="edit({{ $post->id }})"
                                        class="text-blue-600 hover:text-blue-900 bg-blue-100 hover:bg-blue-200 p-2 rounded-full transition-all">
                                    ...
                                    <button wire:click="confirmDelete({{ $post->id }})"
                                        class="text-red-600 hover:text-red-900 bg-red-100 hover:bg-red-200 p-2 rounded-full transition-all">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none"
                                            viewBox="0 0 24 24" stroke="currentColor">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <tr>
                            <td colspan="4" class="px-6 py-10 text-center text-gray-500">
                                <div class="flex flex-col items-center justify-center">
                                    ...
                                    <p class="text-lg font-semibold mb-1">Belum ada postingan</p>
                                    <p class="text-sm">Tidak ada postingan yang ditemukan berdasarkan filter yang
                                        dipilih</p>
                                </div>
                            </td>
                        </tr>
        ...
        <div x-cloak x-show="$wire.deleteConfirmation"
            ...
            <p class="mb-6 text-gray-700">Apakah Anda yakin ingin menghapus postingan ini? Tindakan ini tidak dapat
                dibatalkan.</p>
