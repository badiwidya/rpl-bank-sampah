    ...
    <div class="py-8 w-4/5 mx-auto @cannot('create', \App\Models\Sampah::class) max-w-3/5 @endcannot">
            ...
            @can('create', \App\Models\Sampah::class)
                <div class="flex gap-4">
                    <a href="{{ route('admin.dashboard.sampah.log') }}" wire:navigate
                        class="bg-white hover:bg-emerald-600 drop-shadow-md hover:cursor-pointer text-emerald-600 hover:text-white border-1 border-emerald-600 font-medium py-2 px-4 rounded-lg flex items-center transition duration-150 ease-in-out">
                        Log
                    </a>
        ...
        @if (auth()->user()->role === 'admin')
            ...
            <div x-cloak wire:show="editModal"
                ...
                <h3 class="text-lg font-semibold mb-4">{{ $mode === 'edit' ? 'Edit Sampah' : 'Tambah Sampah Baru' }}
                </h3>

                <form wire:submit.prevent="{{ $mode === 'edit' ? 'update' : 'store' }}">
                    <div class="mb-4 flex items-center gap-2">
                        <div
                            class="flex items-center justify-center h-36 w-36 overflow-hidden rounded-md border-1 border-dashed bg-gray-300">
                            @if ($imageUpload)
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="nama" wire:model.defer="dataInput.nama"
                            class="w-full border-gray-300 px-4 py-2 placeholder:text-sm border rounded-md focus:outline-none focus:ring-2 focus:ring-emerald-400 transition duration-300 @error('dataInput.nama') border-red-500 focus:ring-red-500 @enderror" />
