            ...
            <form action="{{ route('admin.login.submit') }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" placeholder="Masukkan Email/No. Telepon" name="login"
                           class="w-full px-4 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-green-400 transition duration-300 @error('login') border-red-500 focus:ring-red-500 @enderror"/>
                    @error('login')
                ...
                <div class="mb-4">
                    ...
                    <div class="relative">
                        <input type="password" placeholder="Masukkan Password" name="password"
                               class="w-full px-4 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-green-400 transition duration-300 @error('password') border-red-500 focus:ring-red-500 @enderror"/>
